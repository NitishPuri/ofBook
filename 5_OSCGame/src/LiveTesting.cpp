...
#define LOG ofLogNotice("LiveTesting")

LiveTesting::LiveTesting() {
    sender.setup("192.168.0.90", 8000);
    //this is the ip address of your ipad/android and the port it should be
    //set to receive on

    receiver.setup(8001);
    //this is the port you're game will receive data on.
    //For us this is the important one! 
    // Set your mobile device to send on this port.

    m.setAddress("/game");
    //this is OSC's URL like naming convention. 
    //You can use a root url address like structure and then everything under that address will
    //be accessable by that message. It's very similar to a folder path on your hard drive.
    //You can think of the game folder as your root directory and all the bits that are 
